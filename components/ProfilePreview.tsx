                                   ...
                                   user}: ProfilePreviewProps)
{
    ...
    >("posts");
    return (
        <div className="grid grid-cols-1 w-full bg-white text-gray-800 relative">
            ...
            <div className="p-6 flex flex-col items-center bg-white pt-9">
                ...
                <button
                    className=" w-1/2 sm:w-1/3 md:w-1/3 lg:w-[40%] bg-gray-200 text-black py-1 rounded-lg border-2 border-gray-400 shadow-md hover:bg-gray-400 transition font-semibold my-4"
                    onClick={() => console.log("Edit profile clicked")}
                >
                    Edit
                </button>

                <div className=" flex flex-col items-center lg:items-center text-center lg:text-left space-y-1">
                    <span className="text-2xl font-semibold">{user.name}</span>
                    <span className="text-gray-500">@{user.username}</span>
                    <span className="text-sm text-gray-600 max-w-xs">{user.bio}</span>

                    <div className=" flex flex-col items-center lg:items-center space-y-1">
