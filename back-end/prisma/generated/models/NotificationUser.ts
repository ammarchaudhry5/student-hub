...
export type NotificationUserScalarWhereWithAggregatesInput = {
  ...
  id?: Prisma.IntWithAggregatesFilter<"NotificationUser"> | number
  ...
  isActor?: Prisma.BoolWithAggregatesFilter<"NotificationUser"> | boolean
...
export type NotificationUserUpdateInput = {
  isActor?: Prisma.BoolFieldUpdateOperationsInput | boolean
...
export type NotificationUserOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "notificationId" | "userId" | "isActor" | "createdAt", ExtArgs["result"]["notificationUser"]>
...
export interface NotificationUserDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many NotificationUsers and only return the `id`
   * const notificationUserWithIdOnly = await prisma.notificationUser.createManyAndReturn({
   *   select: { id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more NotificationUsers and only return the `id`
   * const notificationUserWithIdOnly = await prisma.notificationUser.updateManyAndReturn({
   *   select: { id: true },
   *   where: {
   *     // ... provide filter here
   *   },
